...
**Updated by:** Restored vlrggapi AWS rotator overlay; enable with env keys
...
- No AWS IP rotator (paid). Official `vlrggapi` image scrapes vlr.gg slowly (1 page at a time, 1.5s delay).
